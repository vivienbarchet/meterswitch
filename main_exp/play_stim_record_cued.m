function [playbackstart, stopTime, resp_com, respt] = play_stim_record(subject,parameter, listen_sound, Fs, cond, meter, switchtime, trialnum)
%% visual display
...
playbackEnd = playbackstart + switchtime;
...
fixation_cross = '+';
Screen('TextSize', my_window, cross_size);
DrawFormattedText(my_window, fixation_cross, 'center', 'center', [0 255 0]);
Screen(my_window, 'Flip');


playbackEnd = playbackEnd + tiempo_L-0.01 - switchtime;
