function [playbackstart, stopTime, resp_com, respt] = play_stim_record(subject,parameter, listen_sound, Fs, cond, phase, trialnum, s)
%% visual display
...
fileOut =([parameter.save_path  '\' char(phase) '\trial' num2str(trialnum) '_' num2str(cond) '_' char(s) '.wav']);
audiowrite(fileOut, audiodata', Fs);

fileOut =([parameter.save_path  '\' char(phase) '\trial' num2str(trialnum) '_' num2str(cond) '_' char(s) '_metronome.wav']);
